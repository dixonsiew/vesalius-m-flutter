...
import 'services/medical_history_auth.dart';
    ...
    return MultiProvider(
      ...
      child: GetMaterialApp(
        ...
        getPages: [
          ...
          GetPage(name: MedicalHistoryAuth.routeName, page: () => const MedicalHistoryAuth()),
          GetPage(name: MedicalHistory.routeName, page: () => const MedicalHistory()),
        ],
