...
class PatientAppointment {
  ...
  String? apptPatientPrn;
  String? apptPatientName;
  String? apptPackageName;
  String? apptPackagePurchaseNo;
  String? apptPackageImage;
  String? patientPackageExpiry;
  ...
  PatientAppointment({
    ...
    this.apptSessionType,
    this.apptPatientPrn,
    this.apptPatientName,
    this.apptPackageName,
    this.apptPackagePurchaseNo,
    this.apptPackageImage,
    this.patientPackageExpiry,
  ...
  factory PatientAppointment.fromJson(Map<String, dynamic> json) {
    ...
    return PatientAppointment(
      ...
      apptSlotType: app['apptSlotType'],
      apptSessionType: app['apptSessionType'],
      apptPatientPrn: app['apptPatientPrn'],
      apptPatientName: app['apptPatientName'],
      apptPackageName: app['apptPackageName'],
      apptPackagePurchaseNo: app['apptPackagePurchaseNo'],
      apptPackageImage: app['apptPackageImage'],
      patientPackageExpiry: app['patientPackageExpiry'],
      sessionStartTime: app['sessionStartTime'],
      sessionEndTime: app['sessionEndTime'],
    );
  }

  DateTime? get packageExpDateTime {
    if (patientPackageExpiry == null) {
      return null;
    }

    DateTime dt = DateTime.parse(patientPackageExpiry!);
    return dt.toLocal();
  }
}
