    ...
    final navBarItems = <BottomNavigationBarItem>[
      BottomNavigationBarItem(
        icon: Padding(
          ...
          child: Image.asset(
            index == 0 ? 'images/icon/home.png' : 'images/icon/home0.png',
            width: 16.0,
            height: 16.0,
            fit: BoxFit.cover,
          ),
      ...
      BottomNavigationBarItem(
        icon: Padding(
          padding: const EdgeInsets.only(top: 10.0, bottom: 8.0),
          child: Image.asset(
            index == 1 ? 'images/icon/appointment.png' : 'images/icon/appointment0.png',
            width: 16.0,
            height: 16.0,
            fit: BoxFit.cover,
          ),
      ...
      BottomNavigationBarItem(
        icon: Padding(
          padding: const EdgeInsets.only(top: 10.0, bottom: 8.0),
          child: Image.asset(
            index == 2 ? 'images/icon/profile.png' : 'images/icon/profile0.png',
            width: 16.0,
            height: 16.0,
            fit: BoxFit.cover,
          ),
