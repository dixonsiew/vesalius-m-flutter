...
class _ProfileState extends State<Profile> with AutomaticKeepAliveClientMixin<Profile> {
  ...
  void load() async {
    try {
      ...
      ctrl.setPurchase(purchase == null ? kPurchase : kPurchase);
...
class BackCard0 extends StatelessWidget {
...
class FrontCard0 extends StatelessWidget {

  final ProfileCtrl ctrl = Get.put(ProfileCtrl());

  FrontCard0({super.key});
      ...
      children: [
        ...
        const Spacer(),
          /*
                ...
                const SizedBox(height: 16.0),
                Text(
                  ctrl.hospitalData?.website ?? 'www.islandhospital.com',
                  style: kTextStyle1.copyWith(
                    fontSize: 10.0,
                    fontWeight: FontWeight.w400,
                    color: kTextColor6,
                ...
                Row(
                  ...
                  children: [
                    Material(
                      ...
                      child: InkWell(
                        onTap: () {
                          makePhoneCallNum(ctrl.hospitalData?.contactInfoApptCall ?? '+6042383388');
                        },
                        borderRadius: BorderRadius.circular(5.0),
                        child: Padding(
                          padding: const EdgeInsets.all(4.0),
                          child: Text(
                            'Contact ${ctrl.hospitalData?.contactInfoApptDisplay ?? '+604 238 3388'}',
                            style: kTextStyle1.copyWith(
                              fontSize: 10.0,
                              fontWeight: FontWeight.w400,
                              color: kTextColor6,
                    ...
                    Material(
                      ...
                      child: InkWell(
                        onTap: () {
                          makePhoneCallNum(ctrl.hospitalData?.contact24Call ?? '+6042268527');
                        },
                        borderRadius: BorderRadius.circular(5.0),
                        child: Padding(
                          padding: const EdgeInsets.all(4.0),
                          child: Text(
                            'Emergency Hotline ${ctrl.hospitalData?.contact24Display ?? '+604 226 8527'}',
                            style: kTextStyle1.copyWith(
                              fontSize: 10.0,
                              fontWeight: FontWeight.w400,
                              color: kTextColor6,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Material(
                      ...
                      child: InkWell(
                        onTap: () {
                          launchWANum(ctrl.hospitalData?.contactWhatsAppCall ?? '6042383333');
                        },
                        borderRadius: BorderRadius.circular(5.0),
                        child: Padding(
                          padding: const EdgeInsets.all(4.0),
                          child: Row(
                            children: [
                              ...
                              Text(
                                ctrl.hospitalData?.contactWhatsAppDisplay ?? '+604 238 3333',
                                style: kTextStyle1.copyWith(
                                  fontSize: 10.0,
                                  fontWeight: FontWeight.w400,
                                  color: kTextColor6,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            blurRadius: 5.0,
            color: kColor1.withValues(alpha: 0.65),
          ),
        ],
      ),
      child: Stack(
