...
class _HomeState extends State<Home> with AutomaticKeepAliveClientMixin<Home>, WidgetsBindingObserver {
  ...
  List<AppService> filterAppService(List<AppService> la) {
    la.removeWhere((x) => x.image == 'family.png' || 
    x.image == 'feedback.png' || 
    x.image == 'little-explorer.png' || 
    x.image == 'golden-pearl.png' || 
    x.image == 'way-find.png' || 
    x.image == 'logistic-arrangements.png');
    return la;
  }
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(50.0),
            borderSide: BorderSide(color: const Color(0xFFEAEAEA).withValues(alpha: 0.21)),
          ),
