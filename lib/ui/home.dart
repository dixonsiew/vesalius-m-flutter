...
class _HomeState extends State<Home> with AutomaticKeepAliveClientMixin<Home>, WidgetsBindingObserver {
  ...
  List<AppService> filterAppService(List<AppService> la) {
    final a1 = la.firstWhere((x) => x.image == 'doctor-information.png');
    final a2 = la.firstWhere((x) => x.image == 'hospital-information.png');
    final a3 = la.firstWhere((x) => x.image == 'investigation-reports.png');
    final lax = [a3, a1, a2];
    return lax;
  }
