            ...
            children: [
              ...
              IconButton(
                ...
                icon: Container(
                  ...
                  height: 24.0,
                  decoration: BoxDecoration(
                    color: quantity >= widget.data.package.availableToPurchase ? kColor1.withValues(alpha: 0.3) : kSecondaryColor,
                    shape: BoxShape.circle,
                  ),
                  child: Center(
                    child: Icon(
                      Icons.add,
                      size: 16.0,
                      color: quantity >= widget.data.package.availableToPurchase ? kColor2 : kPrimaryColor,
                    ),
                  ),
                ),
              ),
