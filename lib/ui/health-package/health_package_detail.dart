                    ...
                    icon: Obx(() =>
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: isDisableBtnRemove ? const Color(0xFFDBDBDB).withValues(alpha: 0.3) : kSecondaryColor,
                        ...
                        child: Center(
                          child: Icon(
                            Icons.remove,
                            size: 16.0,
                            color: isDisableBtnRemove ? const Color(0xFFB1B1B1) : kPrimaryColor,
                          ),
                        ),
                      ),
                    ),
                ...
                Obx(() =>
                  IconButton(
                    ...
                    icon: Container(
                      ...
                      height: 32.0,
                      decoration: BoxDecoration(
                        color: isDisableBtnAdd? const Color(0xFFDBDBDB).withValues(alpha: 0.3) : kSecondaryColor,
                        shape: BoxShape.circle,
                      ),
                      child: Center(
                        child: Icon(
                          Icons.add,
                          size: 16.0,
                          color: isDisableBtnAdd ? const Color(0xFFB1B1B1) : kPrimaryColor,
                        ),
                      ),
                    ),
                  ),
