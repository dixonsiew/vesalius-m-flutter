          ...
          Padding(
            ...
            child: RichText(
              text: TextSpan(
                children: [
                  TextSpan(
                    text: '''TERMS OF USE FOR ISLAND HOSPITAL SDN BHD’S MOBILE APPLICATION\n\n''',
                    style: kTextStylex2,
                  ),
                  longText(
'''
Thank you for downloading Island Hospital’s (the “Company”) Mobile Application (the “Application”). By downloading and using the Application, and by receiving services through the Application (“Services”), you agree to be bound by the terms of service set out below (the “Agreement”).
...
'''
                  ...
                  TextSpan(
                    children: [
                      ...
                      longText(
'''
In order to access Healthcare Services personalised to you, you are required to be patient in Island Hospital. Please ensure all the information within the Application are correct. By completing the Account information, you represent and warrant that all of the personal information provided are true and correct. You agree to maintain accurate, complete and up-to-date information in your Account. Failure to maintain accurate, complete and up-to-date Account information, may result in the inability to access or use the Healthcare Services. The Company reserves the right to refuse or cancel your Account or your use of the Application and/or the Services if you have not provided complete and accurate information regarding your identity and/or have not provided accurate health information and the failure to provide such accurate information amounts to a fundamental breach of this Agreement on your part.
'''                   ),
                    ],
                  ),
                  TextSpan(
                  ...
                  longText(
'''
Upon the addition of a new patient profile, account verification will be performed. Verification against Island Hospital’s database such as Full Name, NRIC / Passport, Date of Birth and email address will be performed.  A verification code will be sent via email to the registered email address. When the correct verification code is given by the user, the patient profile will be created.
'''               ),
                  TextSpan(
                    children: [
                      TextSpan(
...
'''
                  ...
                  longText(
'''
All information including your personal and sensitive data collected through the Application shall be processed in accordance to Island Hospital Sdn Bhd’s privacy policy, which can be found at https://islandhospital.com/personal-data-protection-act.''', false
                  ),
                ],
              ),
            ),
