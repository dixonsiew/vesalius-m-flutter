                    ...
                    children: [
                      ...
                      Obx(() =>
                        Container(
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: ctrl.xcaseType == 'New Case' ? kTextColor1 : kColor1.withValues(alpha: 0.45)),
                            boxShadow: [
                              BoxShadow(
                      ...
                      Obx(() =>
                        Container(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(5.0),
                            border: Border.all(color: ctrl.xcaseType == 'Follow Up' ? kTextColor1 : kColor1.withValues(alpha: 0.45)),
                            boxShadow: [
                              BoxShadow(
                                color: kColor1.withValues(alpha: 0.3),
                                blurRadius: 8.0,
