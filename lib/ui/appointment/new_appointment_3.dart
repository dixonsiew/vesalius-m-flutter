...
class _NewAppointment3State extends State<NewAppointment3> {
  ...
  void onNext() async {
    ...
    final doctorSpecialty = o.doctorSpecialty;
    ...
    if (newAppointment3Ctrl.appointmentSessionList.isEmpty) {
  ...
  List<Widget> buildSessionList() {
    List<Widget> lx = [];
    for (int i = 0; i < newAppointment3Ctrl.appointmentSessionList.length; i++) {
      lx.addAll([
        SessionItem(data: newAppointment3Ctrl.appointmentSessionList[i]),
                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Text(
                          newAppointment3Ctrl.appointmentSessionList.isEmpty ? 'What time do you prefer?' : 'Choose your preferred slot',
                          style: kTextStyle1.copyWith(
                            fontSize: 18.0,
                            fontWeight: FontWeight.w600,
                            color: kTextColor1,
                        ...
                        /* Obx(() =>
                          Container(
                            decoration: BoxDecoration(
                              color: Colors.white,
                              borderRadius: BorderRadius.circular(5.0),
                              border: Border.all(color: ctrl.timeSession == 'morning' ? kTextColor1 : const Color(0xFFDBDBDB).withOpacity(0.45)),
                              boxShadow: [
                                BoxShadow(
                                  color: kBgColor2.withOpacity(0.1),
                                  offset: const Offset(0, 4.0),
                        ...
                        Obx(() =>
                          Container(
                            decoration: BoxDecoration(
                              color: Colors.white,
                              borderRadius: BorderRadius.circular(5.0),
                              border: Border.all(color: ctrl.timeSession == 'afternoon' ? kTextColor1 : const Color(0xFFDBDBDB).withOpacity(0.45)),
                              boxShadow: [
                                BoxShadow(
                                  color: kBgColor2.withOpacity(0.1),
                                  offset: const Offset(0, 4.0),
            ...
            child: Column(
              ...
              children: [
                Obx(() =>
                  AppElevatedButton(
                    text: 'Next',
                    onPressed: (ctrl.xappointmentSession == null && newAppointment3Ctrl.appointmentSessionList.isNotEmpty) || (ctrl.xdate == null && newAppointment3Ctrl.appointmentSessionList.isEmpty) ? null : onNext,
                  ),
                ),
                const SizedBox(height: 16.0),
                AppOutlinedButton(
    ...
    return Obx(() =>
      Container(
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(5.0),
          border: Border.all(color: ctrl.xappointmentSession?.session == data.session ? kTextColor1 : const Color(0xFFDBDBDB).withOpacity(0.45)),
          boxShadow: [
            BoxShadow(
              color: kBgColor2.withOpacity(0.1),
              offset: const Offset(0, 4.0),
            ...
            child: Padding(
              ...
              child: Text(
                ...
                style: kTextStyle1.copyWith(
                  fontSize: 16.0,
                  fontWeight: FontWeight.w600,
                  color: ctrl.xappointmentSession?.session == data.session ? kTextColor1 : kTextColor2,
                ),
              ),
            ),
          ),
