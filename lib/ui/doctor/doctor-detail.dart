...
import 'package:vesalius_m_flutter/components/doctor/doctor-detail-header.dart';
...
class DoctorDetail extends StatefulWidget {
  ...
  static final String routeName = 'DoctorDetail';
...
class _DoctorDetailState extends State<DoctorDetail> {
  ...
  Widget buildContact() {
    if (doctorInfo != null && doctorInfo.doctorContact != null && doctorInfo.doctorContact.isNotEmpty) {
      return Padding(
        padding: EdgeInsets.only(left: 15.0, right: 15.0, top: 30.0, bottom: 50.0),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
  ...
  List<Widget> buildSuiteList() {
    List<Widget> ls = [
      DetailHeader(title: 'Suite No. / Floor'),
    ];
  ...
  List<Widget> buildSpecialityList() {
    List<Widget> ls = [
      DetailHeader(title: 'Specialities'),
    ];
  ...
  List<Widget> buildQualificationList() {
    List<Widget> ls = [
      DetailHeader(title: 'Qualificatons'),
    ];
  ...
  List<Widget> buildLanguageList() {
    List<Widget> ls = [
      DetailHeader(title: 'Languages Spoken'),
    ];
