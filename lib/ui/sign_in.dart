                            ...
                            child: Obx(() => 
                              Container(
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(color: ctrl.signInOpt == SignInOpt.mobile ? kTextColor1 : kColor1.withValues(alpha: 0.45)),
                                  boxShadow: [
                                    BoxShadow(
                          ...
                          Expanded(
                            child: Obx(() =>
                              Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5.0),
                                  border: Border.all(color: ctrl.signInOpt == SignInOpt.email ? kTextColor1 : kColor1.withValues(alpha: 0.45)),
                                  boxShadow: [
                                    BoxShadow(
                                      color: kColor1.withValues(alpha: 0.3),
                                      blurRadius: 8.0,
