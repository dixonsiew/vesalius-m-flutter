...
class _AppStartState extends State<AppStart> {
  ...
  final List<ContentX> lx = [
    const ContentX(
      ...
      desc: 'Select your preferred doctor and make an appointment.',
      width: 182.73,
      height: 242.0,
    ),
    const ContentX(
      image: 'started-3.png',
      title: 'Find Out More about CVSKL',
      desc: 'Learn all about us and what makes us a \n Centre of Excellence #knowYourOptions',
      width: 312.0,
      height: 172.0,
    ),
  ];
