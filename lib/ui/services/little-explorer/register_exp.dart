...
class _RegisterExpState extends State<RegisterExp> {
  ...
  DateTime get dobFirstDate {
    final dt = DateTime.now();
    return Jiffy.parseFromDateTime(DateTime(dt.year, dt.month, dt.day)).subtract(years: 12).dateTime;
  }

  void onNext() {
    KidsMembershipForm frm = KidsMembershipForm(
      name: txtname.text, 
      dob: txtdob.text, 
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: validate,
                          validator: ValidationBuilder(requiredMessage: 'Explorer Name is required').required().minLength(1, 'Explorer Name is required').build(),
                          controller: txtname,
