              ...
              child: Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, i) {
                    final o = ctrl.list[i];
                    return MemberItem(
                      key: ValueKey(o.kidsMembershipId),
                      data: o,
                    );
                  },
                ),
    ...
    return Obx(() =>
      Container(
        ...
        child: Material(
          ...
          child: InkWell(
            onTap: () {
              if (ctrl.hasMemberId(data.kidsMembershipId)) {
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        data.kidsName.isEmpty ? '' : data.kidsName[0].toUpperCase(),
                  ...
                  ctrl.hasMemberId(data.kidsMembershipId) ?
                  const Icon(
                    Icons.check_circle,
                    color: kPrimaryColor,
