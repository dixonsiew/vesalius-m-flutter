...
class PartnersExt extends StatefulWidget {
  ...
  @override
  State<PartnersExt> createState() => _PartnersExtState();
}

class _PartnersExtState extends State<PartnersExt> {

  InAppWebViewController? webViewController;
  PullToRefreshController? pullToRefreshController;
  final GlobalKey webViewKey = GlobalKey();

  final PartnersExtCtrl ctrl = Get.put(PartnersExtCtrl());
...
class PartnersExtCtrl extends GetxController {
