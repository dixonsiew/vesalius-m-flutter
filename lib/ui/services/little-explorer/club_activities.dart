...
import 'package:vesalius_m_flutter/controllers/services/little-explorer/club_activities_ctrl.dart';
...
class _ClubActivitiesState extends State<ClubActivities> {
  ...
  void load() async {
    try {
      ...
      List<KidsActivity> lx = await ClubsService.getAllLittleKidsActivities(ctrl.page, kPageSize);
      ctrl.setList(lx);
  ...
  void loadMore() async {
    ...
    try {
      ...
      List<KidsActivity> lx = await ClubsService.getAllLittleKidsActivities(p, kPageSize);
      if (lx.isEmpty) {
      ...
      child: Padding(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (context, i) {
            ...
            final o = ctrl.list[i];
            return ClubActivityItem(key: ValueKey(o.kidsActivityId), data: o);
          },
        ),
      ),
    );
