...
class _ClubActivityDetailState extends State<ClubActivityDetail> {
  ...
  void onSubmit() {
    joinClubActivityCtrl.setKidsActivity(widget.data);
          ...
          child: Scrollbar(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  KidsActivityImage(
                    img: widget.data.kidsActivityImage,
  ...
  Widget build(BuildContext context) {
    return InnerPage(
      title: widget.data.kidsActivityName,
      body: SafeArea(
        child: buildContent(),
      ),
    );
