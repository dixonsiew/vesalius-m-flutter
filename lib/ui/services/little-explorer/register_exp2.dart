...
import 'package:vesalius_m_flutter/ui/services/little-explorer/register_exp.dart';

import 'register_exp3.dart';
import 'select_doctype.dart';
import 'select_gender.dart';
import 'select_nationality.dart';
...
class _RegisterExp2State extends State<RegisterExp2> {
  ...
  void onNext() {
    KidsGuardianForm frm = KidsGuardianForm(
      name: txtname.text, 
      dob: txtdob.text, 
    ...
    registerExpCtrl.setGuardianForm(frm);
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: validate,
                          validator: ValidationBuilder(requiredMessage: 'Guardian Name is required').required().minLength(1, 'Guardian Name is required').build(),
                          controller: txtname,
