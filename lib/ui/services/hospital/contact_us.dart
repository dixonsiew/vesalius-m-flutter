                ...
                GestureDetector(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ctrl.data?.companyName ?? 'Island Hospital Sdn. Bhd.',
                        style: kTextStyle1.copyWith(
                          fontSize: 16.0,
                      ...
                      Text(
                        ctrl.data?.reg ?? '199401038023 (323705-A)',
                        style: kTextStyle1.copyWith(
                          fontSize: 12.0,
                          fontWeight: FontWeight.w400,
                          color: Colors.white,
                      ...
                      Text(
                        ctrl.data?.addr1 ?? '308, Macalister Road,',
                        style: kTextStyle1.copyWith(
                          fontSize: 16.0,
                          fontWeight: FontWeight.w400,
                          color: Colors.white,
                      ...
                      Text(
                        '${ctrl.data?.postcode ?? '10450'} ${ctrl.data?.addr2 ?? 'George Town,'}',
                        style: kTextStyle1.copyWith(
                          fontSize: 16.0,
                          fontWeight: FontWeight.w400,
                          color: Colors.white,
                      ...
                      Text(
                        '${ctrl.data?.state ?? 'Penang,'} ${ctrl.data?.country ?? 'Malaysia'}',
                        style: kTextStyle1.copyWith(
                          fontSize: 16.0,
                          fontWeight: FontWeight.w400,
                          color: Colors.white,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        makePhoneCallNum(ctrl.data?.contactInfoApptCall ?? '+6042383388');
                      },
                      child: Text(
                        ctrl.data?.contactInfoApptDisplay ?? '+604 238 3388',
                        style: kTextStyle1.copyWith(
                          fontSize: 16.0,
                          fontWeight: FontWeight.w400,
                          color: Colors.white,
                    ...
                    GestureDetector(
                      onTap: () {
                        makePhoneCallNum(ctrl.data?.contact24Call ?? '+6042268527');
                      },
                      child: Text(
                        ctrl.data?.contact24Display ?? '+604 226 8527',
                        style: kTextStyle1.copyWith(
                          fontSize: 16.0,
                          fontWeight: FontWeight.w400,
                          color: Colors.white,
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        sendMail(ctrl.data?.email ?? 'info@islandhospital.com');
                      },
                      child: Text(
                        ctrl.data?.email ?? 'info@islandhospital.com',
                        style: kTextStyle1.copyWith(
                          fontSize: 16.0,
                          fontWeight: FontWeight.w400,
                          color: Colors.white,
