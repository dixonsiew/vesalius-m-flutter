...
import 'package:vesalius_m_flutter/controllers/services/golden-pearl/register_exp3_ctrl.dart';
...
import 'package:vesalius_m_flutter/ui/services/golden_pearl.dart';
import 'package:vesalius_m_flutter/ui/services/little-explorer/select_language.dart';
...
class _RegisterExp3State extends State<RegisterExp3> {
        ...
        child: Column(
          ...
          children: [
            ...
            RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(
                    text: '${registerExpCtrl.goldenPearlMembershipForm?.name} ',
                    style: kTextStyle1.copyWith(
                      fontSize: 14.0,
                      fontWeight: FontWeight.w600,
                      color: kTextColor1,
            ...
            AppElevatedButton(
              ...
              onPressed: () {
                Get.back();
                Get.until((route) => Get.currentRoute == GoldenPearl.routeName);
              },
            ),
          ],
        ),
  ...
  void onSubmit() async {
    final frm1 = registerExpCtrl.goldenPearlMembershipForm!;
    final frm2 = registerExpCtrl.nokForm!;
    try {
      final o = {
        'goldenName': frm1.name,
        'goldenDob': frm1.dob,
        'goldenDocType': frm1.idType,
        'goldenDocNumber': frm1.idNum,
        'goldenGender': frm1.gender,
        'goldenNationality': frm1.nationality,
        'goldenEmail': frm1.email,
        'nokName': frm2.name,
        'nokDob': frm2.dob,
        'nokDocType': frm2.idType,
        'nokDocNumber': frm2.idNum,
        'nokGender': frm2.gender,
        'nokNationality': frm2.nationality,
        'nokEmail': frm2.email,
        'nokHomeContact': '${frm2.homeContact1}${frm2.homeContact2}',
        'nokMobileContact': '${frm2.hp1}${frm2.hp2}',
        'nokAddress1': txtaddr.text,
        'nokAddress2': '',
        'nokAddress3': '',
        'nokPostCode': txtpostcode.text,
        'nokState': txtstate.text,
        'nokCountryCode': ctrl.selectedCountry?.countryCode ?? 'MY',
      ...
      if (AuthManager.instance.isLogin) {
        await ClubsService.postGoldenPearlMembership(o);
      }

      else {
        await GuestModeService.postGoldenPearlMembership(o);
      }
