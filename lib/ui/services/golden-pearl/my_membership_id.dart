...
import 'package:vesalius_m_flutter/controllers/services/golden-pearl/my_membership_ctrl.dart';
import 'package:vesalius_m_flutter/controllers/services/golden-pearl/my_membership_id_ctrl.dart';
...
class _MyMembershipIdState extends State<MyMembershipId> {
  ...
  void onNext() async {
    try {
      ...
      List<GoldenPearlMembership> lx = await GuestModeService.getGoldenPearlMembership(txtidnum.text);
      if (lx.isEmpty) {
