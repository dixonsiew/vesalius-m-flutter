...
class FromHospital extends StatefulWidget {

  const FromHospital({super.key});

  @override
  State<FromHospital> createState() => _FromHospitalState();
}

class _FromHospitalState extends State<FromHospital> {
