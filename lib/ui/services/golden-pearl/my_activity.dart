...
import 'package:vesalius_m_flutter/controllers/services/golden-pearl/my_activity_ctrl.dart';
...
class _MyActivityState extends State<MyActivity> {
  ...
  void load() async {
    try {
      ...
      List<MyGoldenPearlActivity> lx = await ClubsService.getAllGoldenPearlMyActivities(ctrl.page, kPageSize);
      ctrl.setList(lx);
  ...
  void loadMore() async {
    ...
    try {
      ...
      List<MyGoldenPearlActivity> lx = await ClubsService.getAllGoldenPearlMyActivities(p, kPageSize);
      if (lx.isEmpty) {
...
class ActivityItem extends StatelessWidget {
  ...
  final MyGoldenPearlActivity data;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: kColor1.withValues(alpha: 0.09),
            blurRadius: 8.0,
          ),
        ],
      ),
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: kColor27.withValues(alpha: 0.2),
                    ),
                    child: Center(
                      child: Text(
                        data.goldenName[0].toUpperCase(),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: kColor3.withValues(alpha: 0.26),
