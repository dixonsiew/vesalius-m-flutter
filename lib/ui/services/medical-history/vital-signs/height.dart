...
import 'package:vesalius_m_flutter/controllers/services/medical-history/vital-signs/height_ctrl.dart';
...
class _HeightState extends State<Height> {
  ...
  final HeightCtrl ctrl = Get.put(HeightCtrl());
  ...
  void load() async {
    try {
      ...
      List<VitalSignsData> lx = await VesaliusService.getVitalSignHistory('HEIGHT', branchDetails!.branch!.branchId!, branchDetails.prn!, widget.date);
      ctrl.setList(lx);
  ...
  Widget buildChart() {
    return Container(
      ...
      child: HeightChart(list: ctrl.list),
    );
  }
