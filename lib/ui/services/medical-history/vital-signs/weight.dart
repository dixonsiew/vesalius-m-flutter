...
import 'package:vesalius_m_flutter/controllers/services/medical-history/vital-signs/weight_ctrl.dart';
...
class _WeightState extends State<Weight> {
  ...
  final WeightCtrl ctrl = Get.put(WeightCtrl());
  ...
  void load() async {
    try {
      ...
      List<VitalSignsData> lx = await VesaliusService.getVitalSignHistory('WEIGHT', branchDetails!.branch!.branchId!, branchDetails.prn!, widget.date);
      ctrl.setList(lx);
  ...
  Widget buildChart() {
    return Container(
      ...
      child: WeightChart(list: ctrl.list),
    );
  }
