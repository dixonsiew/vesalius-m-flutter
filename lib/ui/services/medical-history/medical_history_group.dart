...
class _MedicalHistoryGroupState extends State<MedicalHistoryGroup> {
  ...
  void load() async {
    try {
      ...
      await sortList(lx);
      await DataManager.instance.setItem('patientVisit-3', ctrl.list);
    }
  ...
  String getDate(PatientVisit o) {
    String s = o.novaVisit?.registrationDate ?? '';
            ...
            child: Row(
              children: [
                Container(
                  ...
                  height: 48.0,
                  decoration: BoxDecoration(
                    color: visitType == 'OUTPATIENT' ? kSecondaryColor2 : kSecondaryColor,
