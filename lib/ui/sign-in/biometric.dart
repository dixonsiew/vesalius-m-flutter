...
class _BiometricState extends State<Biometric> {
  ...
  void onBiometric() async {
    ...
    if (a) {
      ...
      await UserService.disableFirstTimeBiometric();
      ...
      AuthManager.instance.isFirstTimeBiometric = false;
      showSuccess();
    }
  }
              ...
              Padding(
                ...
                child: Obx(() =>
                  Text(
                    ...
                    'Login with your Face ID for faster, easier access to your account.',
                    style: kTextStyle1.copyWith(
                      fontSize: 16.0,
                      fontWeight: FontWeight.w400,
                      color: kTextColor2,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Obx(() =>
                  AppElevatedButton(
                    text: 'Enable ${ctrl.name == 'fingerprint' ? 'Fingerprint' : 'Face ID'}',
