...
const kPrimaryColor = Color(0xFF19709A);
const kPrimaryColor2 = Color(0xFFC81E5D);
const kPrimaryColor3 = Color(0xFF565758);
const kPrimaryColor4 = Color(0xFF88D8DF);
final kSecondaryColor = const Color(0xFFE1EDFF).withValues(alpha: 0.5);
final kSecondaryColor2 = const Color(0xFFE1EDFF).withValues(alpha: 0.3);
const kSecondaryColor3 = Color(0xFFFFE7F0);
const kPrimaryBgColor = Color(0xFFCE2525);
const kSecondaryBgColor = Color(0xFFFCD0D0);
...
const kTextColor7 = Color(0xFF127099);
...
const kChartLineColor = Color(0xFF1D9FFE);
...
const kHiveBoxName = 'vesaliusmcvsuatBox';
const kHiveBoxUserName = 'vesaliusmcvsuatUserBox';
