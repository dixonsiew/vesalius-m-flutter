...
Future<Map<String, dynamic>> authenticate(o) async {
  ...
  try {
    var res = await ApiHelper.dio.post('$SERVER/login', data: o);
...
Future<Map<String, dynamic>> signUp(num branchId, String dob, String email, String fullname, String id) async {
  ...
  try {
    ...
    var res = await ApiHelper.dio.post('$SERVER/admin/self-sign-up', data: o);
    m = res.data;
  }
...
Future<Map<String, dynamic>> resetPassword(String email) async {
  ...
  try {
    var res = await ApiHelper.dio.post('$SERVER/admin/self-reset-password/1/$email', data: {});
    m = res.data;
  }
...
Future<Map<String, dynamic>> postVerificationCode(String verificationCode) async {
  ...
  try {
    var res = await ApiHelper.tokenDioInterceptor.post('$SERVER/user/verify/$verificationCode', data: {});
    m = res.data;
  }
...
Future<UserDetails?> getUser() async {
  ...
  try {
    var res = await ApiHelper.tokenDioInterceptor.get('$SERVER/user');
